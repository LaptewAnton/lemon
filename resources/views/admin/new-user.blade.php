...
@section('main')
            <form method="post" action="/new-user/add">
                ...
                <div class="mb-3">
                    ...
                    <input maxlength="60" required type="email" class="form-control" name="title" id="title">
                </div>
                <div class="mb-3">
                    <label for="password" class="form-label">Пароль</label>
                    <input maxlength="60" required type="password" class="form-control" name="title" id="title">
                </div>
                <div class="mb-3">
